...
- Fix: sighting observer field during export
- Fix: sighting duplicate form
...
- Allow unlock if no effort but not in charge of the management
- Do not apply effort field on sightning/follower during merge
