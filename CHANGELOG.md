# Changelog
Tout les changements notables du projet seront consignés dans ce fichier.

Le format de ce changelog est basé sur [Keep a Changelog](https://keepachangelog.com/en/1.0.0/),
